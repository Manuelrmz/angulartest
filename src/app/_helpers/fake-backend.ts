  ...
  backend.connections.subscribe((connection:MockConnection) => {
    ...
    setTimeout(() => {
      ...
      if(connection.request.url.endsWith('/api/authenticate') && connection.request.method === RequestMethod.Post){
        ...
        //check user credentials and return fake jwt token
      ...
      //Check for fake auth toekn in header and return test user if valid, this security is implemented server side
